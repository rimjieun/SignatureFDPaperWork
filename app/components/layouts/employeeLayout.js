        ...
        return (
            <div>
                <div>
                    <ul id="nav-side" className="side-nav fixed" style={{transform: "translateX(0%)"}}>
                        ...
                        <ul className="fa-ul">
                            ...
                            <li><a href="#/employee/handbook"><i className="fa-li fa fa-check-square"></i>&nbsp;
                        ...
                        <nav className="nav-extended  FDbrownLight" role="navigation">
                            <div className="container">
                                <div className="nav-wrapper">
                                    ...
                                    <a href="#" data-activates="nav-side" className="button-collapse"><i
                                        className="material-icons">menu</i></a>
                                </div>
                                <div>
                                    <div className="row">
                                        <ul className="left" style={{marginRight: "30%"}}>
                                            <a className="list-group-item" href="#"><i className="fa fa-download fa-2x"
                                                                                       aria-hidden="true"></i>&nbsp;
                                                CurrentFileName.PDF</a>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <a href="http://www.signaturefd.com/disclosure-information">Disclosure</a>&nbsp&nbsp&nbsp</span>
                                <a target="_blank" href="https://twitter.com/SignatureFD">&nbsp&nbsp&nbsp<i
                                    className="fa fa-fw fa-twitter fa-lg" aria-hidden="true"></i></a>
                                <a target="_blank" href="https://www.facebook.com/SignatureFD/">&nbsp<i
                                    className="fa fa-fw fa-facebook fa-lg" aria-hidden="true"></i></a>
                                <a target="_blank" href="https://www.linkedin.com/company/signaturefd">&nbsp<i
                                    className="fa fa-fw fa-linkedin fa-lg" aria-hidden="true"></i></a>
                                <a target="_blank" href="http://www.signaturefd.com/feed/rss/">&nbsp<i
                                    className="fa fa-fw fa-rss fa-lg" aria-hidden="true"></i></a>
                            </p>
                        </div>
                    </div>
                </footer>
